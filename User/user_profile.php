...
<html lang="en" dir="ltr">
  <head>
    ...
    .photo img {
        max-width: 100%;
        height: 100%;
        background-image: "src:../upload/placeholder.png";
    }
                        ...
                        <div class="container">
                           <div class="left_div">
                                <div class="photo">
                                    <?php
                                        ...
                                        while ($row = mysqli_fetch_array($res)){
                                            ...
                                            if ($row["photo"] != '') {
                                                ?><img src="<?php echo $row["photo"]; ?> "     height="300px" width="250px" alt="user photo"><?php
                                            } else {
                                                ?><img src="../upload/placeholder.png" height="300px" width="250px" alt="user photo"><?php
                                            }
                                ...
                                if (isset($_POST["submit"])) {
                                    ...
                                    mysqli_query($db, "update user set photo='".$imagepath."' where userid='".$_SESSION['id']."'");
                            ...
                            <div class="right_div">
                                <div class="profile-details">
                                    <?php
                                     $res5 = mysqli_query($db, "select * from user where userid='$_SESSION[id]' ");
                                ...
                                <form method="post">
                                    <div class="form-group">
                                        <label for="occupation" class="text-right">occupation:</label>
                                        <input type="text" class="form-control custom"  name="occupation" value="<?php echo $occupation; ?>" disabled/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control custom"  name="phone_number" value="<?php echo $phone_number; ?>" />
                                    </div> 
